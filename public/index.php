...
<div class="p-3 list-group text-center">
    ...
    <a href="forms/Identique_A.php" class="list-group-item list-group-item-action">Exemple Validateur d'Identicité de chaîne de charactère<i>(Armand Vanderhoeven)</i></a>    <a href="forms/superieur_a.php" class="list-group-item list-group-item-action">Exemple Validateur pour vérifier qu'une valeur est supérieur à une autre valeur <i>(Melvin Pollier)</i></a>

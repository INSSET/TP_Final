...
<head>
    <meta charset="UTF-8">
    <title>Formulaire de Validation d'URL</title>
...
<div class="m-1 p-3 bg-info bg-opacity-10 border border-info border-start-0 border-end-0">
    Exemple d'utilisation du validateur d'URL
</div>
...
<div class="grid text-center">
    <div class="m-3 p-3 bg-light" style="grid-column: 2/3">
        ...
        <form class="form-floating" action="#" method="post">
            <input type="text" name="data" value="<?= $validator->getData()?>" class="form-control <?= $validator->ifNoOk("is-invalid") ?>" id="exemple">
